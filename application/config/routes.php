...
$route['press'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'] = "press/index/$1/$2";

$route['stat/popstate'] = "popstate/index";
$route['stat/popstate/([a-zA-Z0-9_-]+)'] = "popstate/$1";
$route['stat/popstate/graph/([a-zA-Z0-9_-]+)'] = "popstate/graph/$1";