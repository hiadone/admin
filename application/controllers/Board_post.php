...
class Board_post extends CB_Controller
{
     ...
     * 모델을 로딩합니다
     */
    protected $models = array('Post', 'Post_meta', 'Post_extra_vars','Board_admin');
    ...
    public function lists($brd_key = '')
    {
        ...
        $view['view']['list']['boardadminlist']  = $this->Board_admin_model
                    ->get_board_admin_member(element('brd_id', element('board', $list)));
        $view['view']['list']['bgr_name'] = $this->board_group->item_id('bgr_name',element('bgr_id', element('board', $list)));
        /**
         * 레이아웃을 정의합니다
         */
