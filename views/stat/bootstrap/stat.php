        ...
        ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir); ?>">후팝업 목록</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/realgraph'); ?>">실시간 그래프</a></li>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><i class="fa fa-link"></i><a href="<?php echo goto_url(prep_url(html_escape(element('pl_referer', $result)))); ?>" target="_blank"><?php echo prep_url(html_escape(element('pl_referer', $result))); ?></a></td>
                            <td><?php echo display_datetime(element('pl_datetime', $result), 'full'); ?></td>
                            <!-- <td><?php echo element('pl_hit', $result) ? element('pl_hit', $result) : ''; ?></td> -->
                            <!-- <td><?php echo element('pl_ip', $result); ?></td> -->
