    ...
    <div class="box-table">
        <div class="box-table-header">
            <ul class="nav nav-pills">
                    <li role="presentation" ><a href="<?php echo site_url($this->pagedir); ?>">후팝업 목록</a></li>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            ?>
                                <input type="number" class="form-control" name="day" value="<?php echo set_value('day', 180); ?>" /> 일 이상된 후팝업 로그를 모두 검색합니다.
