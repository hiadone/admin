            ...
            <div class="form-horizontal">
                                ...
                                <tr>
                                    ...
                                    <td class="form-inline">
                                        ...
                                        <?php if (element('cde_filename', $detail)) { ?>
                                            <a href="<?php echo admin_url('cmall/itemdownload/download/' . element('cde_id', $detail)); ?>"><?php echo html_escape(element('cde_originname', $detail));?></a>
                                        <?php } ?>
                                    </td>
                ...
                <?php for ($k = 1; $k<= 10; $k++) { ?>
                    <div class="form-group">
                        ...
                        ?>
                            <img src="<?php echo thumb_url('cmallitem', element('cit_file_' . $k, element('data', $view)), 80); ?>" alt="<?php echo html_escape(element('cde_title', $detail)); ?>" title="<?php echo html_escape(element('cde_title', $detail)); ?>" />
