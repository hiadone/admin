        ...
        <div class="form-horizontal box-table">
            ...
            if (element('link_count', element('board', $view)) > 0) {
                ...
                for ($i = 0; $i < $link_count; $i++) {
                    ...
                    $pln_start = html_escape(element('pln_start', element($i, element('link', $view))));
                    $pln_end = html_escape(element('pln_end', element($i, element('link', $view))));
                    $link_column = $link ? 'post_link_update[' . element('pln_id', element($i, element('link', $view))) . ']' : 'post_link[' . $i . ']';
            ?>
                <div class="form-group">
                    <label for="<?php echo $link_column; ?>" class="col-sm-2 control-label">후팝업 URL #<?php echo $i+1; ?></label>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-4">
                        시간 : <input type="text" class="form-control per15" name="pln_start_<?php echo $link_column; ?>" id="pln_start_<?php echo $link_column; ?>" value="<?php echo set_value($link_column, $pln_start); ?>" />~
                        <input type="text" class="form-control per15" name="pln_end_<?php echo $link_column; ?>" id="pln_end_<?php echo $link_column; ?>" value="<?php echo set_value($link_column, $pln_end); ?>" />
                    </div>
                </div>
            <?php
                }
