...
<div class="board">
    ...
    <?php if (element('link_count', $view) > 0 OR element('file_download_count', $view) > 0) { ?>
        <ul class="list-group">
            ...
            if (element('link_count', $view) > 0) { ?>
                <li class="list-group-item list-group-item-info"><strong>후팝업 URL</strong></li>
            <?php
            foreach (element('link', $view) as $key => $value) {
            ?>
                <li class="list-group-item"><i class="fa fa-link"></i> <a href="<?php echo element('link_link', $value); ?>" target="_blank"><?php echo html_escape(element('pln_url', $value)); ?></a><span class="badge">시간 : <?php echo number_format(element('pln_start', $value)); ?> ~ <?php echo number_format(element('pln_end', $value)); ?></span>
                    <?php if (element('show_url_qrcode', element('board', $view))) { ?>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            ...
            <div class="list-group-item-text" style="min-height:20px;">
            <?php echo html_escape(element('post_js', element('post', $view))); ?>
            </div>
        </li>
        <?php if (element('extra_content', $view)) { ?>
                ...
                <li class="list-group-item">
                    ...
                    <?php 
                    if(element('field_name', $value)==='popstate_url' || element('field_name', $value)==='press_url')
                        echo '<i class="fa fa-link"></i><a href="'.element('output', $value).'" target="_blank">'.element('output', $value).'</a>';
                    else 
                        echo nl2br(html_escape(element('output', $value))); ?>
                    </div>
                </li>
                <?php } ?>
            <?php } ?>
