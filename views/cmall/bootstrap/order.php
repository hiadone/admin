...
?>
    ...
    <div class="form-group">
        <label class="col-lg-2 control-label">실명</label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-2 control-label">휴대폰</label>
        <div class="col-lg-3">
            <input type="text" name="mem_phone" class="form-control" value="<?php echo $this->member->item('mem_phone'); ?>" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 control-label">하고싶은 말</label>
        <div class="col-lg-9">
            <textarea name="cor_content" class="form-control per90" cols="5"></textarea>
        </div>
    </div>
    <p class="market-title">결제정보</p>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            ...
            ?>
                ...
                사용
                <?php echo html_escape($this->depositconfig->item('deposit_name')); ?> : <input type="text" name="order_deposit" id="order_deposit" class="form-control px200" value="0" /> 원
            <?php } else { ?>
