...
$admin_name="";
foreach(element('admin_name', element('config', $view)) as $value){
...
<div class="col-md-6">
    ...
    <!-- Default panel contents -->
        <div class="panel-heading">
            <strong>[<?php echo element('bgr_name',element('config',$view)) ?>]</strong><?php echo html_escape(element('board_name', element('board', $view))); ?><?php if(!empty($admin_name)) echo '<span class="highlight"> - 관리자 '.implode($admin_name,",").'</span>'; ?>
